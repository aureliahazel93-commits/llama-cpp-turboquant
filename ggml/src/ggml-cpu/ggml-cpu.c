...
static const struct ggml_type_traits_cpu type_traits_cpu[GGML_TYPE_COUNT] = {
    ...
    [GGML_TYPE_PLANAR_EDGE] = {
        .from_float               = (ggml_from_float_t) quantize_row_planar_edge_ref,
        .vec_dot                  = (ggml_vec_dot_t) ggml_vec_dot_planar_edge_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
    [GGML_TYPE_ISO_EDGE] = {
        .from_float               = (ggml_from_float_t) quantize_row_iso_edge_ref,
        .vec_dot                  = (ggml_vec_dot_t) ggml_vec_dot_iso_edge_q8_0,
        .vec_dot_type             = GGML_TYPE_Q8_0,
        .nrows                    = 1,
    },
};
